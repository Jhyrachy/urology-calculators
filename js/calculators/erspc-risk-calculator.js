 ...
 * URL explicitly cited in EAU 2026 Table 5.4: https://www.prostatecancer-riskcalculator.com/seven-prostate-cancer-risk-calculators
...
export const meta = {
  ...
  outputs: [
    { id: 'resource', label: 'Official calculator',
      value: 'https://www.prostatecancer-riskcalculator.com/seven-prostate-cancer-risk-calculators' },
    { id: 'citation', label: 'Citation',
      value: 'Roobol MJ et al. Eur Urol 2012;62:738-749 — ERSPC risk calculator' }
  ],
  references: [
    'EAU 2026 Prostate Cancer Guidelines — Sect. 5.4.1, Table 5.4 [181]',
    'Schröder FH et al. Lancet 2014;383:2027-2037 — ERSPC screening',
    'Roobol MJ et al. Eur Urol 2012;62:738-749 — ERSPC risk calculator'
  ],
  isDIY: false,
  disclaimer: 'ERSPC Risk Calculator beta coefficients are not reproduced here. Please use the official calculator at prostatecancer-riskcalculator.com.'
};
